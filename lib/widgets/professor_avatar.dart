...
class ProfessorAvatarState extends State<ProfessorAvatar>
  ...
  @override
  void didUpdateWidget(ProfessorAvatar oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.emotion != widget.emotion) _updateAnimations(widget.emotion);
    if (oldWidget.speechText != widget.speechText && widget.speechText != null) {
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                colors: [
                  ...
                  _ringColor.withValues(alpha: 0.08),
                ],
              ),
