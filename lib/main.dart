  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/haroof-quiz':   (_) => const QuizScreen(
              screenTitle: 'حروف کوئز',
            ),
...
class _AppWrapperState extends State<AppWrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    final provider = context.read<AppProvider>();
    // If user has not completed onboarding, show welcome screen.
    if (provider.currentUser == null ||
        !provider.currentUser!.hasCompletedOnboarding) {
