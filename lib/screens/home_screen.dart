        ...
        slivers: [
                    ...
                    children: [
                      Row(
                        children: [
                          GestureDetector(
                            onTap: _onAvatarTap,
                            child: ProfessorAvatar(emotion: _emotion, size: 76),
                          ),
          ...
          SliverToBoxAdapter(
            child: _SectionHeader(
              ...
              onAction: () => unawaited(Navigator.pushNamed(context, '/lessons-hub')),
            ),
          ),
          SliverToBoxAdapter(
            child: SizedBox(
          ...
          SliverToBoxAdapter(
            child: _SectionHeader(
              ...
              title: 'کوئز',
              actionLabel: 'سب دیکھیں',
              onAction: () => unawaited(Navigator.pushNamed(context, '/quiz-hub')),
...
class _SmallCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => unawaited(Navigator.pushNamed(context, item.route)),
      child: Container(
        width: 90,
