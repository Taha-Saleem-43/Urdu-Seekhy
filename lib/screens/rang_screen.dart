            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  // Next
                  IconButton(
                    onPressed: _current < _colors.length - 1
                        ? () => _goTo(_current + 1)
                        : null,
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: Column(
              children: [
                ...
                Text(data.english,
                    style: TextStyle(
                        fontSize: 14, color: fg.withValues(alpha: 0.65))),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Directionality(
              textDirection: TextDirection.rtl,
              child: Text('${data.urdu} رنگ کی چیزیں',
                ...
                return Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: data.color.withValues(alpha: 0.4), width: 2),
                      boxShadow: [
                        BoxShadow(
