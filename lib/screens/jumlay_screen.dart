...
class JumlayScreen extends StatefulWidget {
  const JumlayScreen({super.key});

  @override
  State<JumlayScreen> createState() => _JumlayScreenState();
}

class _JumlayScreenState extends State<JumlayScreen> {
