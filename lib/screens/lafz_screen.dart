          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [AppTheme.pink, AppTheme.pink.withValues(alpha: 0.7)],
              ),
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AppTheme.pink.withValues(alpha: 0.3), width: 1.5),
              ),
              child: Center(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: levelColor.withValues(alpha: 0.5), width: 1),
              ),
              child: Directionality(
                textDirection: TextDirection.rtl,
                child: Text(
