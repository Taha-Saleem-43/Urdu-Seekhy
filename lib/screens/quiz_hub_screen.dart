...
class _QuizHubScreenState extends State<QuizHubScreen> {
  ...
  static const List<_QuizCard> _quizzes = [
    _QuizCard(
        emoji: '🎤',
        urduTitle: 'حروف کوئز',
        englishSub: 'Speak & Score',
        route: '/haroof-quiz',
        colors: [Color(0xFF9b5de5), Color(0xFF7b3fc4)]),
    _QuizCard(
        emoji: '📝',
        urduTitle: 'الفاظ کوئز',
        englishSub: 'Word Quiz',
        route: '/words-quiz',
        colors: [Color(0xFF3a86ff), Color(0xFF2563eb)]),
    _QuizCard(
        emoji: '💬',
        urduTitle: 'جملہ کوئز',
        englishSub: 'Sentence Quiz',
        route: '/sentences-quiz',
        colors: [Color(0xFF00bbf9), Color(0xFF0090c7)]),
    _QuizCard(
        emoji: '🔗',
        urduTitle: 'ملائیں',
        englishSub: 'Matching',
    ...
    _QuizCard(
        emoji: '🎨',
        urduTitle: 'رنگ کوئز',
        englishSub: 'Colors Quiz',
        route: '/colors-quiz',
        colors: [Color(0xFFff6d00), Color(0xFFcc5700)]),
    _QuizCard(
        emoji: '🐄',
        urduTitle: 'جانور کوئز',
        englishSub: 'Animals Quiz',
        route: '/animals-quiz',
        colors: [Color(0xFF059669), Color(0xFF047857)]),
    _QuizCard(
        emoji: '🍎',
        urduTitle: 'پھل کوئز',
        englishSub: 'Fruits Quiz',
        route: '/fruits-quiz',
  ...
  Widget _buildCard(_QuizCard card, BuildContext context) {
    return GestureDetector(
      onTap: () => unawaited(Navigator.pushNamed(context, card.route)),
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: card.colors[0].withValues(alpha: 0.4),
              blurRadius: 8,
