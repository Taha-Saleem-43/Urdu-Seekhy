...
class _MatchingQuizScreenState extends State<MatchingQuizScreen> {
  ...
  void _startRound() {
    ...
    _selectedEmoji = null;
    _selectedUrdu = null;
    unawaited(TtsService.instance.speak('جوڑیں ملائیں'));
  }
  ...
  void _tryMatch() {
    ...
    if (emojiWord == urduWord) {
      ...
      _totalScore++;
      unawaited(TtsService.instance.speak('شاباش! ${emojiWord.urdu}'));
      ...
      unawaited(TtsService.instance.speak('غلط! دوبارہ کوشش کریں۔'));
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Center(child: ProfessorAvatar(emotion: _emotion, size: 70)),
          ),
                    ...
                    child: Column(
                      ...
                      children: List.generate(_roundWords.length, (i) {
                        ...
                        if (matched) {
                          ...
                          bg = const Color(0xFFf15bb5).withValues(alpha: 0.15);
